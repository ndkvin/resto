...
<body>
	...
	<header class="header clearfix element_to_stick">
		...
		<nav class="main-menu">
		    ...
		    <ul>
		        <li><a href="reservations.html" class="btn_top">Login / Register</a></li>
		    </ul>
		</nav>
	</div>
	</header>
		    ...
		    <div class="container margin_120_100 home_intro">
		        <div class="row justify-content-center text-center">
		            <div class="col-lg-7" data-cue="slideInUp" data-delay="500">
		                ...
		                <p>Foores Restaurant, menghadirkan pengalaman kuliner yang luar biasa dengan hidangan yang memikat dan cita rasa yang memanjakan lidah Anda. Kami bangga menyajikan hidangan berkualitas tinggi yang terinspirasi oleh bahan-bahan segar dan pilihan terbaik dari seluruh dunia.</p>
		        ...
		        <div class="row flex-lg-row-reverse"> 
                    <div class="col-lg-5 offset-lg-1 align-self-center mb-4 mb-md-0">
                        <div class="intro_txt" data-cue="slideInUp" data-delay="500">
                            ...
                            <p class="lead">Foores Restaurant, menghadirkan pengalaman kuliner yang luar biasa dengan hidangan yang memikat dan cita rasa yang memanjakan lidah Anda. Kami bangga menyajikan hidangan berkualitas tinggi yang terinspirasi oleh bahan-bahan segar dan pilihan terbaik dari seluruh dunia.</p>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="box_how" data-cue="slideInUp">
                                    <figure><img src="img/lazy-placeholder-100-100-white.png" data-src="img/how_1.svg" alt="" width="100" height="110" class="lazy"></figure>
                                    <h3>For Every Taste</h3>
                                    <p>Perpaduan sempurna antara kreativitas, inovasi, dan tradisi, kami menciptakan hidangan yang unik dan tak terlupakan. Dari hidangan klasik hingga kreasi baru yang modern, setiap hidangan kami dirancang untuk memanjakan selera Anda.</p>
                                </div>
                                <div class="box_how" data-cue="slideInUp">
                                    <figure><img src="img/lazy-placeholder-100-100-white.png" data-src="img/how_2.svg" alt="" width="100" height="110" class="lazy"></figure>
                                    <h3>Fresh Ingredients</h3>
                                    <p>Kami percaya bahwa kualitas bahan baku adalah kunci dari hidangan yang istimewa. Oleh karena itu, kami selalu memastikan bahwa setiap bahan yang digunakan di restoran kami adalah segar, berkualitas, dan bebas dari bahan tambahan yang tidak diinginkan.</p>
                                </div>
                            </div>
                            <div class="col-lg-6 align-self-center">
                                <div class="box_how" data-cue="slideInUp">
                                    <figure><img src="img/lazy-placeholder-100-100-white.png" data-src="img/how_3.svg" alt="" width="100" height="110" class="lazy"></figure>
                                    <h3>Experienced Chefs</h3>
                                    <p>Kami bangga memiliki tim chef yang berbakat dan berpengalaman di dapur kami. Setiap hidangan yang kami sajikan adalah hasil dari keahlian dan dedikasi chef-chef kami yang telah melalui pelatihan dan pengalaman bertahun-tahun dalam industri kuliner.</p>
                                </div>
                            </div>
                        </div>
                    </div>
	        ...
	        <div class="row">
	            ...
	            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
	                <div class="footer_wp">
	                    ...
	                    <h3>Reservations</h3>
	                    <p><a href="tel:009442323221">+62 82-123-456-789</a><br><a href="#0">reservations@Foores.com</a></p>
	                </div>
	            </div>
	            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
	                <div class="footer_wp">
