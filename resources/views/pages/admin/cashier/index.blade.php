        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">New Cashier</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin.cashier.store') }}" method="POST" id="formCreate"
    ...
    <div class="row mt-5">
                        ...
                        <tbody>
                            ...
                            @foreach ($cashiers as $cashier)
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $cashier->email }}</td>
                                    <td>
        ...
        <div class="modal fade" id="editCashier" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Edit Cashier</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="/admin/cashier/id" method="POST" id="formCreate">
                            @method('PUT')
                            @csrf
                            <div class="col-md-12">
                                <label for="name" class="form-label">Name</label>
    ...
    @section('scripts')
        <script>
            ...
            $('#editCashier').on('show.bs.modal', function(e) {
                ...
                const url = `/admin/cashier/${id}`;

                $.get(url, function(response) {
                    $(e.currentTarget).find('form[action="/admin/cashier/id"]').attr('action',
                        `/admin/cashier/${id}`);
